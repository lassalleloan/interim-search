CREATE PROCEDURE [dbo].[Proc_GetCountRejectedMissionEmploymentAgency]

AS

	SELECT [tbl_employmentAgency].[employmentAgency_Name], COUNT(DISTINCT [tbl_avaibility].[idAvaibility]) AS 'count_RejectedMission'
	FROM [tbl_avaibility]
	...
	WHERE [tbl_avaibility].[avaibility_AcceptedMission]=0
